...
**Files:**
- Create: resources/scripts/verify-stage0.ps1
- Reference: resources/docs/superpowers/specs/2026-06-21-ai-after-sales-platform-development-design.md
...
Create resources/scripts/verify-stage0.ps1 with:
...
~~~powershell
git add -- resources/scripts/verify-stage0.ps1 resources/docs/superpowers/plans/2026-06-22-stage-0-requirements-architecture-baseline.md
...
**Files:**
- Create: resources/docs/product/product-brief.md
- Create: resources/docs/product/glossary.md
- Reference: resources/docs/superpowers/specs/项目概要.md
- Reference: resources/docs/superpowers/specs/2026-06-21-ai-after-sales-platform-development-design.md
...
~~~powershell
Select-String -Path resources/docs/product/product-brief.md,resources/docs/product/glossary.md -Pattern 'After-sales application','Work order','Mock Agent','Tenant' -SimpleMatch
~~~
...
~~~powershell
git add -- resources/docs/product/product-brief.md resources/docs/product/glossary.md
...
**Files:**
- Create: resources/docs/product/actors-and-capabilities.md
- Create: resources/docs/security/access-control-matrix.md
...
~~~powershell
git add -- resources/docs/product/actors-and-capabilities.md resources/docs/security/access-control-matrix.md
...
**Files:**
- Create: resources/docs/product/use-cases.md
- Create: resources/docs/product/acceptance-criteria.md
...
~~~powershell
$count = (Select-String -Path resources/docs/product/acceptance-criteria.md -Pattern '^### AC-\d{3}' -CaseSensitive).Count
...
~~~powershell
git add -- resources/docs/product/use-cases.md resources/docs/product/acceptance-criteria.md
...
**Files:**
- Create: resources/docs/domain/state-machines.md
...
~~~powershell
git add -- resources/docs/domain/state-machines.md
...
**Files:**
- Create: resources/docs/architecture/context-and-containers.md
- Create: resources/docs/architecture/module-boundaries.md
...
~~~powershell
git add -- resources/docs/architecture/context-and-containers.md resources/docs/architecture/module-boundaries.md
...
**Files:**
- Create: resources/docs/data/core-data-model.md
...
Include tenant/user/role/module permission, game product/version/purchase method/offer, order/item/payment, entitlement/CDK/gift, conversation/message/queue, work-order/record/refund/reissue/account action, knowledge base/document/chunk, audit/Agent log.
...
~~~powershell
git add -- resources/docs/data/core-data-model.md
...
**Files:**
- Create: resources/docs/api/api-standards.md
- Create: resources/docs/api/event-contracts.md
...
~~~powershell
git add -- resources/docs/api/api-standards.md resources/docs/api/event-contracts.md
...
**Files:**
- Create: resources/docs/operations/non-functional-requirements.md
- Create: resources/docs/security/threat-model.md
...
~~~powershell
git add -- resources/docs/operations/non-functional-requirements.md resources/docs/security/threat-model.md
...
**Files:**
- Create: resources/docs/adr/0001-monorepo-and-application-layout.md
- Create: resources/docs/adr/0002-modular-monolith-and-agent-boundary.md
- Create: resources/docs/adr/0003-local-development-topology.md
...
~~~powershell
git add -- resources/docs/adr/0001-monorepo-and-application-layout.md resources/docs/adr/0002-modular-monolith-and-agent-boundary.md resources/docs/adr/0003-local-development-topology.md
...
**Files:**
- Create: resources/docs/stage-0-traceability.md
...
$traceability = Get-Content -Raw resources/docs/stage-0-traceability.md
...
~~~powershell
git add -- resources/docs/stage-0-traceability.md
